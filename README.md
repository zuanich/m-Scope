...
It uses a 1.28" 240x240 Round LCD connected to Raspberry Pico. Here is a [Github]([https://www.github.com](https://www.pcbway.com/project/shareproject/Raspberry_Pi_Pico_with_GC9A01_Round_Display_using_Arduino_IDE_and_TFT_eSPI_Library.html) "connection diagram").
